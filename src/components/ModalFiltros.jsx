            ...
            >
                ...
                <div className="flex items-center justify-between border-b border-gray-800 pb-3 sm:pb-4">
                    <div className="flex items-center gap-2">
                        ...
                        <h2 className="font-title font-bold text-xl sm:text-2xl text-white">{t('projetos.filterTitle')}</h2>
                    </div>
                    <button 
                        onClick={onClose}
                    ...
                    <div className="flex flex-wrap gap-2 max-h-56 overflow-y-auto no-scrollbar p-1">
                        {allTechs.map((tech) => (
                            <button
                                ...
                                className={`px-3.5 py-1.5 sm:px-4 sm:py-2 rounded-full text-xs font-medium transition-all cursor-pointer active:scale-95 ${
                                    selectedTech === tech
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between border-t border-gray-800 pt-4 gap-3">
                    ...
                    <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
                        ...
                        <button 
                            onClick={onClose}
                            className="w-full sm:w-auto bg-blue-600 hover:bg-blue-500 text-white text-xs sm:text-sm font-medium px-5 py-2.5 rounded-xl transition-colors cursor-pointer text-center"
                        >
