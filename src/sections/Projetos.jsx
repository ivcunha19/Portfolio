...
const Projetos = () => {
    ...
    return (
        <section id='projetos' className='relative z-10 min-h-screen w-full flex flex-col justify-center items-center px-3 sm:px-6 py-16 sm:py-24 gap-6 sm:gap-8 overflow-hidden'>
            ...
            <div className='flex flex-wrap justify-center items-center gap-2.5 sm:gap-3 pointer-events-auto z-20'>
                <button
                    onClick={() => setIsFilterModalOpen(true)}
                    className='bg-blue-600 hover:bg-blue-500 text-white font-medium px-4 sm:px-5 py-2 sm:py-2.5 rounded-full text-xs sm:text-sm flex items-center gap-2 shadow-lg shadow-blue-500/20 transition-all hover:scale-105 active:scale-95 cursor-pointer'
                >
                ...
                {selectedTech !== 'Todos' && (
                    <span className='bg-gray-900 border border-gray-800 text-blue-300 text-xs px-3 py-1.5 rounded-full flex items-center gap-1.5'>
                        ...
                        <button 
                            ...
                            className='hover:text-white ml-1 cursor-pointer p-0.5'
            ...
            <div className='relative w-full max-w-7xl pointer-events-auto my-2 sm:my-4 group/carousel'>
                {/* Botões de Rolagem Manual (Desktop) */}
                <button 
                ...
                <div 
                    ...
                    className='w-full overflow-x-auto no-scrollbar py-4 sm:py-6 scroll-smooth snap-x snap-mandatory'
                >
                    {filteredProjetos.length > 0 ? (
                        <div className='flex gap-4 sm:gap-6 px-4 sm:px-8 md:px-16 min-w-full justify-start md:justify-center flex-nowrap py-2'>
